...
//登录接口
export const reqLogin = (data: t.LoginFormData) => request.post<t.LoginResponseData>("/v1/login", data)
//退出登录
...
//修改用户
export const updateUser = (id: string, data: tuser.UpdateUserRequest) =>
    request.put(`/v1/user/update/${id}`, data)
// 查询详情
